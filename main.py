...
print("\n\nTraining Comparison\n\n")
compare(match_list_noisy_channel_train, match_list_n_gram_train, match_list_unsupervised_rules_train, list=train, plot_title="Training")
...
compare(match_list_noisy_channel_test, match_list_n_gram_test, match_list_unsupervised_rules_test, list=test, plot_title="Testing")
...
compare_with_bigram(text, test_ngram, plot_title=" Testing ")
compare_with_trigram(text, test_ngram, plot_title=" Testing ")
